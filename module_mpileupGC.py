...
def getGcContentForEachBase(chromosome, region_list, wing, myfh):
    ...
    if len(region_list) > window:
        ...
        for idx, bs in enumerate(region_list[wing: len(region_list) - wing - 1]):
            i = idx + wing
            #sys.stdout.write('{0}\t{1}\t{2}\t{3}\t{4}\n'.format(chromosome, bs[0], bs[1], bs[2], G_C/window))
            #mytable.append([chromosome, bs[0], bs[1], bs[2], G_C/window])
...
'''
ref = '/home/wangchangzheng/project/repTime/test_H1000/hg19_nochr.fa'
bam = '/home/wangchangzheng/project/repTime/test_H1000/NA12892.mapped.ILLUMINA.bwa.CEU.high_coverage_pcr_free.20130906.bam'
chr = '22'
outdir = '/home/wangchangzheng/project/repTime/my_script/example'
wing = 200
